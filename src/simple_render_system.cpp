...
namespace lve {
	...
	void SimpleRenderSystem::renderGameObjects(VkCommandBuffer commandBuffer, std::vector<LveGameObject> &gameObjects, LveCamera &camera) {
		...
		for(auto& obj: gameObjects) {
			...
			obj.transform.translation.z += 0.00001f;
